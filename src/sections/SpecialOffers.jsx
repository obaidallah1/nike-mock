...
<h2 className=' font-palanquin text-4xl capitalize font-bold lg:max-w-lg'><span className="text-coral-red">
    Special
  </span> Offer
  <br />
</h2>
...
<Button label='Learn more' backgroundColor="bg-white" borderColor="border-slate-gray" iconURL={arrowRight} textColor="text-slate-gray"/>
</div>
</div>
    </section>
  )
